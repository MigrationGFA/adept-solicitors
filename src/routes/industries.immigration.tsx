...
const industry = industries.find((i) => i.slug === "immigration")!;

export const Route = createFileRoute("/industries/immigration")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "/industries/immigration" },
    ],
    links: [{ rel: "canonical", href: "/industries/immigration" }],
  }),
  component: () => (
    <>
      <PageHero
