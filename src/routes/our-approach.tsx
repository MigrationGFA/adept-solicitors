        ...
        <div className="space-y-10">
          <div>
            ...
            <p className="text-foreground/80 leading-relaxed text-lg">
              We start by listening. Before we propose strategy, we make sure we understand the
              matter, the people, the jurisdictions, and the desired outcome.
            </p>
          </div>
          <div>
            ...
            <p className="text-foreground/80 leading-relaxed text-lg">
              We propose a written legal strategy with explicit scope, milestones, deliverables, and
              budget. No surprises.
            </p>
          </div>
          <div>
            ...
            <p className="text-foreground/80 leading-relaxed text-lg">
              Partners lead the work. Junior attorneys support. We never hand off your matter to an
          ...
          <div>
            ...
            <p className="text-foreground/80 leading-relaxed text-lg">
              Every engagement closes with clean records, a final memo, and a clear handover. You
              should never have to ask 'what happened with that matter?'
            </p>
          </div>
        </div>
