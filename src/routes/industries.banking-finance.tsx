...
const industry = industries.find((i) => i.slug === "banking-finance")!;

export const Route = createFileRoute("/industries/banking-finance")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "/industries/banking-finance" },
    ],
    links: [{ rel: "canonical", href: "/industries/banking-finance" }],
  }),
  component: () => (
    <>
      <PageHero
