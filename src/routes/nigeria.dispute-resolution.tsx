...
const service = nigeriaServices.find((s) => s.slug === "dispute-resolution")!;

export const Route = createFileRoute("/nigeria/dispute-resolution")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "/nigeria/dispute-resolution" },
    ],
    links: [{ rel: "canonical", href: "/nigeria/dispute-resolution" }],
  }),
  component: () => (
    <ServicePageTemplate
      service={service}
