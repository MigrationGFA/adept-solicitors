...
const industry = industries.find((i) => i.slug === "technology-startups")!;

export const Route = createFileRoute("/industries/technology-startups")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "/industries/technology-startups" },
    ],
    links: [{ rel: "canonical", href: "/industries/technology-startups" }],
  }),
  component: () => (
    <>
      <PageHero
        ...
        breadcrumbs={[{ to: "/", label: "Home" }, { to: "/industries", label: "Industries" }, { label: industry.name }]}
      />
      <section className="container-prose py-20 grid lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2 space-y-10">
          <div>
            <div className="eyebrow mb-3">Overview</div>
            <h2 className="font-display text-3xl font-semibold text-navy mb-5">A practice built for the {industry.name.toLowerCase()} sector.</h2>
        ...
        <aside><ConsultationForm variant="compact" title="Speak with a sector specialist" /></aside>
      </section>
      <CTABanner />
    </>
  ),
