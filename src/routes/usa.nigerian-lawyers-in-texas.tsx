...
const service = usaServices.find((s) => s.slug === "nigerian-lawyers-in-texas")!;

export const Route = createFileRoute("/usa/nigerian-lawyers-in-texas")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "/usa/nigerian-lawyers-in-texas" },
    ],
    links: [{ rel: "canonical", href: "/usa/nigerian-lawyers-in-texas" }],
  }),
  component: () => (
    <ServicePageTemplate
      service={service}
