  ...
  head: () => ({
    meta: [
      { title: "About Adept Consultants — Adept Consultants" },
      {
        name: "description",
        content:
          "An international legal advisory firm built to serve clients whose work crosses borders.",
      },
        ...
        <div className="space-y-10">
          <div>
            ...
            <p className="text-foreground/80 leading-relaxed text-lg">
              Adept Legal Practitioners & Consultants was founded to fill a clear gap: clients with
              legal interests in both the United States and Nigeria deserved a single firm that
              understood both jurisdictions deeply, not two disconnected counsel exchanging emails
              across time zones.
            </p>
          </div>
          <div>
            ...
            <p className="text-foreground/80 leading-relaxed text-lg">
              We represent diaspora individuals and families, Nigerian businesses expanding
              internationally, U.S. companies operating in Africa, and global investors looking to
              deploy capital across our practice regions.
            </p>
          </div>
          <div>
            ...
            <p className="text-foreground/80 leading-relaxed text-lg">
              Senior attorney attention on every matter. Transparent, written fee arrangements.
              Discreet, reputation-aware handling. Documented, audit-ready records. These are not
              aspirations — they are operating standards.
            </p>
          </div>
        </div>
